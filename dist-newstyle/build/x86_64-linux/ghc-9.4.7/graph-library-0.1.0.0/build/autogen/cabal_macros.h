...
/* package graph-library-0.1.0.0 */
#ifndef VERSION_graph_library
#define VERSION_graph_library "0.1.0.0"
#endif /* VERSION_graph_library */
#ifndef MIN_VERSION_graph_library
#define MIN_VERSION_graph_library(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_graph_library */
...
#define CURRENT_PACKAGE_KEY "graph-library-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "graph-library-0.1.0.0-inplace"
